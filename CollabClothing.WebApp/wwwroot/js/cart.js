            ...
            success: function (response) {
                ...
                $.each(response, function (e, item) {
                    html += "<div class=\"row border - top border - bottom\">"
                        ...
                        + "<a href=\"#\" class=\"a-link btn_desc\" data-id=\"" + item.productId + "\" data-sizeid=\"" + item.size + "\">-</a><input id=\"txt_quantity_" + item.productId + "\" value=\"" + item.quantity + "\" class=\"border-quantity-cart\"/><a href=\"#\" class=\"a-link btn_asc\" data-id=\"" + item.productId + "\" data-sizeid=\"" + item.size + "\" data-colorid=\"" + item.color + "\">+</a>"
                        + "</div>"
